...
/* ===================================================================
   ⚠️ 已下线，没有接进 ACTIVITIES。要接回来之前请先读完这段。

   问题：这个玩法是「看汉字 → 选拼音」，**要求孩子认拼音**。
   刚学识字的孩子不认拼音，只能瞎猜。而且马立平那套的原则恰恰是
   "visual recognition without pinyin dependence" —— 正好相反。

   拼音在本 app 里的定位是给家长/老师看的辅助（认一认背面、老师改内容），
   不该拿来考孩子。

   要做限时测试的话，得换成不依赖拼音的方向，比如：
     · 听音抢字：放字音 → 四个汉字里限时点出来
     · 闪卡速认：汉字闪现 1 秒后消失 → 四选一
     · 限时找字：给「找一找」加倒计时和计分
   ===================================================================
